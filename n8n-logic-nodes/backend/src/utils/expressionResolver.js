/*
=================================================================
FILE: backend/src/utils/expressionResolver.js (NEW FILE)
=================================================================
This new utility file contains the core logic for resolving
expressions like {{ item.name }} on the backend.
*/
